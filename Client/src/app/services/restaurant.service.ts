  ...
  private restaurants: Restaurant[] = [
    {
      ...
      details: [
        { label: 'Price Range', value: '₹300 - ₹700' },
        { label: 'Timings', value: 'Open: 11 AM - 11 PM' },
        { label: 'Rating', value: '4.5/5 based on 150 reviews' },
        { label: 'Feedback', value: '“Great food, cozy atmosphere!”' }
      ]
    },
    {
      id: 2,
      ...
      details: [
        { label: 'Price Range', value: '₹150 - ₹400' },
        { label: 'Timings', value: 'Open: 9 AM - 10 PM' },
        { label: 'Rating', value: '4.0/5 based on 100 reviews' },
        { label: 'Feedback', value: '“Excellent service!”' }
      ]
    },
    {
      id: 3,
      ...
      details: [
        { label: 'Price Range', value: '₹200 - ₹450' },
        { label: 'Timings', value: 'Open: 11 AM - 12 AM' },
        { label: 'Rating', value: '4.0/5 based on 130 reviews' },
        { label: 'Feedback', value: '“Best Pizza & service both”' }
      ]
    },
    {
      id: 4,
      ...
      details: [
        { label: 'Price Range', value: '₹250 - ₹600' },
        { label: 'Timings', value: 'Open: 12 PM - 10 PM' },
        { label: 'Rating', value: '4.6/5 based on 90 reviews' },
        { label: 'Feedback', value: '“Authentic tandoori dishes, a must-try for spice lovers!”' }
      ]
    },
    {
      id: 5,
      ...
      details: [
        { label: 'Price Range', value: '₹300 - ₹750' },
        { label: 'Timings', value: 'Open: 11 AM - 11 PM' },
        { label: 'Rating', value: '4.7/5 based on 200 reviews' },
        { label: 'Feedback', value: '“Delicious North Indian cuisine, wonderful ambiance.”' }
      ]
    },
    {
      id: 6,
      ...
      details: [
        { label: 'Price Range', value: '₹200 - ₹500' },
        { label: 'Timings', value: 'Open: 10 AM - 10 PM' },
        { label: 'Rating', value: '4.3/5 based on 110 reviews' },
        { label: 'Feedback', value: '“Great mix of Indian and Continental dishes.”' }
      ]
    },
    {
      id: 7,
      ...
      details: [
        { label: 'Price Range', value: '₹100 - ₹300' },
        { label: 'Timings', value: 'Open: 12 PM - 9 PM' },
        { label: 'Rating', value: '4.2/5 based on 80 reviews' },
        { label: 'Feedback', value: '“Street food delights with a modern twist!”' }
      ]
    },
    {
      id: 8,
      ...
      details: [
        { label: 'Price Range', value: '₹150 - ₹350' },
        { label: 'Timings', value: 'Open: 11 AM - 9 PM' },
        { label: 'Rating', value: '4.8/5 based on 70 reviews' },
        { label: 'Feedback', value: '“Home-cooked style meals at affordable prices.”' }
      ]
    },
    {
      id: 9,
      ...
      details: [
        { label: 'Price Range', value: '₹200 - ₹550' },
        { label: 'Timings', value: 'Open: 10 AM - 11 PM' },
        { label: 'Rating', value: '4.5/5 based on 85 reviews' },
        { label: 'Feedback', value: '“Biryani with rich, authentic flavors, generous portions.”' }
      ]
    },
    {
      id: 10,
      ...
      details: [
        { label: 'Price Range', value: '₹50 - ₹200' },
        { label: 'Timings', value: 'Open: 1 PM - 10 PM' },
        { label: 'Rating', value: '4.0/5 based on 120 reviews' },
        { label: 'Feedback', value: '“Delicious chaats and street snacks.”' }
      ]
    },
    {
      id: 11,
      ...
      details: [
        { label: 'Price Range', value: '₹100 - ₹350' },
        { label: 'Timings', value: 'Open: 10 AM - 11 PM' },
        { label: 'Rating', value: '4.4/5 based on 95 reviews' },
        { label: 'Feedback', value: '“Flavors of Mumbai, from pav bhaji to vada pav!”' }
      ]
    },
    {
      id: 12,
      name: 'Punjabi Express',
      description: 'Hearty Punjabi dishes with bold flavors and great service.',
      image: 'https://www.todaystraveller.net/wp-content/uploads/2024/05/Amritsari-Kulcha-2_edit-1024x683.jpg',
      details: [
        { label: 'Price Range', value: '₹200 - ₹600' },
        { label: 'Timings', value: 'Open: 11 AM - 10 PM' },
        { label: 'Rating', value: '4.6/5 based on 90 reviews' },
        { label: 'Feedback', value: '“Hearty Punjabi dishes with bold flavors and great service.”' }
      ]
    }
  ];
