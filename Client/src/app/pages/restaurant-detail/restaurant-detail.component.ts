  ...
  fetchRestaurantsData(): void {
    this.restaurants = [
      ...
      },
      {
        ...
        details: [
          { label: 'Price Range', value: '₹100 - ₹300' },
          { label: 'Timings', value: 'Open: 12 PM - 11 PM' },
          { label: 'Rating', value: '4.4/5 based on 140 reviews' },
      ...
      },
      {
        ...
        details: [
          ...
          { label: 'Timings', value: 'Open: 10 AM - 11 PM' },
          { label: 'Rating', value: '4.6/5 based on 90 reviews' },
          { label: 'Feedback', value: '“Bold Punjabi flavors with excellent service.”' }
        ]
      }
    ];
